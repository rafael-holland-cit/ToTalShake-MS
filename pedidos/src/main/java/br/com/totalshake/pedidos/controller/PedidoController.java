package br.com.totalshake.pedidos.controller;

import br.com.totalshake.pedidos.dto.PedidoDto;
import br.com.totalshake.pedidos.dto.StatusDto;
import br.com.totalshake.pedidos.service.PedidoService;
...
public class PedidoController {
        ...
        public String retornaPorta(@Value("${local.server.port}")String porta){
            return String.format("Requisção respondida pela instância executando na porta %s", porta);
        }
